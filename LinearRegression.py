...
def main():
    ...
    for _ in range(10000):
            ...
            gradientC = sum( error(c,m,xi,yi) for xi , yi in zip(num_friends_good,daily_minutes_good))
            #parital derivative of the squared error with respect to m
            gradientM = sum(error(c,m,xi,yi)*xi for xi , yi in zip(num_friends_good,daily_minutes_good))
